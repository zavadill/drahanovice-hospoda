...
// Import potřebných ikonek z lucide-react
      ...
      <div className='width-p-page'>
        ...
        <div className='flex flex-col gap-5 md:flex-row mx-5'>
            <div className='card-nase'>
                ...
                <p className='nase-podnadpis'>Nabízíme poctivé české pokrmy připravené podle tradičních receptur z kvalitních lokálních surovin.</p>
            </div>
            <div className='card-nase'>
                <div>
                ...
                <p className='nase-podnadpis'>Restaurace pro 50 osob, dva salonky (20 a 50 osob) a letní zahrádka až pro 70 hostů.</p>
            </div>
            <div className='card-nase'>
                <div>
                ...
                <p className='nase-podnadpis'>Kompletní zajištění svateb, rodinných oslav, firemních akcí i jiných společenských událostí.</p>
            </div>
        </div>
      </div>
    </div>
